...
<head>
    ...
    <title>Set</title><meta charset="utf-8"/>
...
<body>
    ...
    <form action = "/WebApp_Collections/set" method = "post">
        <div class = "form-group">
            <div class="text">
                <div class="textfield">
                        <label for = "stringText">Enter the branch<br><br></label>
                        </div>
                		<input type="text" class="form-text" id="string" placeholder="Department" name="name"><br><br>
                		<input type="submit" value="ADD ITEM" name="add">
                        <input type="submit" value="REMOVE ITEM" name="remove"><br><br>
                ...
                <div class = "form-group">
    				...
    				<input type="submit" value="Start MAP" name="next">
    			</div>
            </div>
