...
public class ListAdvanceServlet extends HttpServlet {
	...
	static List<StudentDetail> studentDetailList = new ArrayList<StudentDetail>();
	static List<StudentDetail> byName = new ArrayList<StudentDetail>();
	static List<StudentDetail> byId = new ArrayList<StudentDetail>();
	static List<StudentDetail> byGrade = new ArrayList<StudentDetail>();
	*/
